...
const Income = () => {
  ...
  // ✅ Force selected date to be treated as UTC noon
  const adjustedDate = new Date(date);
  adjustedDate.setUTCHours(12, 0, 0, 0); // noon UTC avoids shifting to previous day
    ...
    <DashboardLayout activeMenu="Income">
      <div className="my-5 mx-auto">
        ...
        <Modal
          ...
          onClose={(id) => setOpenDeleteAlert({ show: false, data: null })}
          title="Delete Income"
        >
          <DeleteAlert
